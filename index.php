...
<!-- Required meta tags -->
    ...
    <!-- tvm SEO-->
        <title>Convert Now: text converter tool</title>
        <meta name="description" content="Website to convert text, convert uppercase to lowercase, convert everything to uppercase, remove spaces between words, text tool, converter">
        <meta name="robots" content="all">
        <meta name="author" content="Thiago Viana">
        <meta name="keywords" content="convert letter to uppercase, change font to lowercase, remove space from sentence, change everything to lowercase, to uppercase, capitalize first letter of each word, convert texts online">
...
<p class="h3 text-center alert alert-info">Welcome to the [Convert Now] Text Generator Tool</p>
...
<div class="alert alert-success role="alert">
 ...
 Do you have any questions about the site or do you want to report a fault? <a href="contact.php">Click here!</a></center>
 </div>
